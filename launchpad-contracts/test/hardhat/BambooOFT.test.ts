...
describe('BambooOFT Test', function () {
    // Constant representing a mock Endpoint ID for testing purposes
    const eidA = 1
    const eidB = 2
    // Declaration of variables to be used in the test suite
    let BambooOFT: ContractFactory
    ...
    before(async function () {
        ...
        BambooOFT = await ethers.getContractFactory('MyOFTMock')
    ...
    beforeEach(async function () {
        ...
        // Deploying two instances of BambooOFT contract with different identifiers and linking them to the mock LZEndpoint
        myOFTA = await BambooOFT.deploy(
            'aOFT',
            'aOFT',
        ...
        // Setting destination endpoints in the LZEndpoint mock for each BambooOFT instance
        ...
        // Setting each BambooOFT instance as a peer of the other in the mock LZEndpoint
