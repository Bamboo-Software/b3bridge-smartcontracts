...
contract CustomCoin is ERC20, Ownable, AccessControl {
    ...
    constructor() ERC20("Wrapped ETH B10B", "wETH") Ownable(msg.sender) {
        // Gán vai trò admin và minter cho người triển khai hợp đồng
    ...
    // Hàm cấp quyền minter cho một địa chỉ
    ...
    // Hàm cấp quyền burner cho một địa chỉ
    ...
    // Hàm kiểm tra xem một địa chỉ có vai trò minter không
    function hasMinterRole(address account) public view returns (bool) {
        return hasRole(MINTER_ROLE, account);
    }

    // Hàm kiểm tra xem một địa chỉ có vai trò burner không
